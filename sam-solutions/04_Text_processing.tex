...
\begin{frame}[fragile]{Группировка и квантификаторы - регулируем повторы}
  ...
  \alert{Группировка выражений} - осуществляется круглыми скобками \regex{(выражение)}\footnotemark[22] 
  \footnotetext[22]{POSIX Extended RE: grep -e или egrep}
